...
from dataset_creation.pretrain.pretrain_dataset import PretrainDataset
...
class OSV5MPretrainDataset(OSV5M, PretrainDataset):
    """Combines OSV5M with PretrainDataset functionalities."""

    pass


# If additional configurations or methods are needed, add them here.
